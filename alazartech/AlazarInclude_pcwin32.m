...
%This function was generated by loadlibrary.m parser version  on Wed Aug 10 13:38:51 2016
%perl options:'AlazarDSP.i -outfile=AlazarInclude.m AlazarApi.h'
...
% unsigned int AlazarBusyFlag ( HANDLE h , BOOLEAN * BusyFlag ); 
fcns.name{fcnNum}='AlazarBusyFlag'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8Ptr'};fcnNum=fcnNum+1;
% unsigned int AlazarTriggeredFlag ( HANDLE h , BOOLEAN * TriggeredFlag ); 
fcns.name{fcnNum}='AlazarTriggeredFlag'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8Ptr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarGetBoardKind'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
...
% unsigned int AlazarAutoCalibrate ( HANDLE h ); 
fcns.name{fcnNum}='AlazarAutoCalibrate'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
...
% unsigned int AlazarInputControlEx ( HANDLE hBoard , U32 uChannel , U32 uCouplingId , U32 uRangeId , U32 uImpedanceId ); 
...
% unsigned int ReadC ( HANDLE h , U8 * DmaBuffer , U32 SizeToRead , U32 LocalAddress ); 
fcns.name{fcnNum}='ReadC'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8Ptr', 'ulong', 'ulong'};fcnNum=fcnNum+1;
% void WriteC ( HANDLE h , U8 * DmaBuffer , U32 SizeToRead , U32 LocalAddress ); 
fcns.name{fcnNum}='WriteC'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'voidPtr', 'uint8Ptr', 'ulong', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarGetTriggerAddressA ( HANDLE h , U32 Record , U32 * TriggerAddress , U32 * TimeStampHighPart , U32 * TimeStampLowPart ); 
fcns.name{fcnNum}='AlazarGetTriggerAddressA'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'ulongPtr', 'ulongPtr', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarGetTriggerAddressB ( HANDLE h , U32 Record , U32 * TriggerAddress , U32 * TimeStampHighPart , U32 * TimeStampLowPart ); 
fcns.name{fcnNum}='AlazarGetTriggerAddressB'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'ulongPtr', 'ulongPtr', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int ATS9462FlashSectorPageRead ( HANDLE h , U32 address , U16 * PageBuff ); 
fcns.name{fcnNum}='ATS9462FlashSectorPageRead'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'uint16Ptr'};fcnNum=fcnNum+1;
% unsigned int ATS9462PageWriteToFlash ( HANDLE h , U32 address , U16 * PageBuff ); 
fcns.name{fcnNum}='ATS9462PageWriteToFlash'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'uint16Ptr'};fcnNum=fcnNum+1;
% unsigned int ATS9462FlashSectorErase ( HANDLE h , int sectorNum ); 
fcns.name{fcnNum}='ATS9462FlashSectorErase'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32'};fcnNum=fcnNum+1;
% unsigned int ATS9462FlashChipErase ( HANDLE h ); 
fcns.name{fcnNum}='ATS9462FlashChipErase'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
% unsigned int SetControlCommand ( HANDLE h , int cmd ); 
fcns.name{fcnNum}='SetControlCommand'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int32'};fcnNum=fcnNum+1;
...
% U32 AlazarReadEx ( HANDLE h , U32 Channel , void * Buffer , int ElementSize , long Record , S64 TransferOffset , U32 TransferLength ); 
fcns.name{fcnNum}='AlazarReadEx'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='ulong'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'voidPtr', 'int32', 'long', 'int64', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarDSPGetModules ( HANDLE boardHandle , U32 numEntries , dsp_module_handle * modules , U32 * numModules ); 
fcns.name{fcnNum}='AlazarDSPGetModules'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'voidPtrPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarDSPGetInfo'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulongPtr', 'uint16Ptr', 'uint16Ptr', 'ulongPtr', 'ulongPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarDSPGenerateWindowFunction'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'ulong', 'singlePtr', 'ulong', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarFFTGetMaxTriggerRepeatRate ( dsp_module_handle dspHandle , U32 fft_size , double * maxTriggerRepeatRate ); 
fcns.name{fcnNum}='AlazarFFTGetMaxTriggerRepeatRate'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'doublePtr'};fcnNum=fcnNum+1;
% unsigned int AlazarFFTBackgroundSubtractionSetRecordS16 ( dsp_module_handle dspHandle , const S16 * record , U32 size_samples ); 
fcns.name{fcnNum}='AlazarFFTBackgroundSubtractionSetRecordS16'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int16Ptr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarFFTBackgroundSubtractionGetRecordS16'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int16Ptr', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarFFTBackgroundSubtractionSetEnabled ( dsp_module_handle dspHandle , U8 enabled ); 
fcns.name{fcnNum}='AlazarFFTBackgroundSubtractionSetEnabled'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarFFTSetWindowFunction'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'singlePtr', 'singlePtr'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarFFTVerificationMode'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8', 'int16Ptr', 'int16Ptr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.name{fcnNum}='AlazarFFTSetup'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint16', 'ulong', 'ulong', 'ulong', 'ulong', 'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarFFTSetScalingAndSlicing ( dsp_module_handle dspHandle , U8 slice_pos , float loge_ampl_mult ); 
fcns.name{fcnNum}='AlazarFFTSetScalingAndSlicing'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8', 'single'};fcnNum=fcnNum+1;
% unsigned int AlazarDSPGetBuffer ( HANDLE boardHandle , void * buffer , U32 timeout_ms ); 
fcns.name{fcnNum}='AlazarDSPGetBuffer'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarDSPGetNextBuffer ( HANDLE boardHandle , void * buffer , U32 bytesToCopy , U32 timeout_ms ); 
fcns.name{fcnNum}='AlazarDSPGetNextBuffer'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'voidPtr', 'ulong', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarDSPGetParameterU32 ( dsp_module_handle dspHandle , U32 parameter , U32 * result ); 
fcns.name{fcnNum}='AlazarDSPGetParameterU32'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarDSPAbortCapture ( HANDLE boardHandle ); 
fcns.name{fcnNum}='AlazarDSPAbortCapture'; fcns.calltype{fcnNum}='cdecl'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr'};fcnNum=fcnNum+1;
...
enuminfo.DSP_MODULE_TYPE=struct('DSP_MODULE_NONE',65535,'DSP_MODULE_FFT',65536,'DSP_MODULE_PCD',65537);
...
enuminfo.DSP_PARAMETERS=struct('DSP_RAW_PLUS_FFT_SUPPORTED',0,'DSP_FFT_SUBTRACTOR_SUPPORTED',1);
...
enuminfo.FFT_OUTPUT_FORMAT=struct('FFT_OUTPUT_FORMAT_U32',0,'FFT_OUTPUT_FORMAT_U16_LOG',1,'FFT_OUTPUT_FORMAT_U16_AMP2',257,'FFT_OUTPUT_FORMAT_U8_LOG',2,'FFT_OUTPUT_FORMAT_U8_AMP2',258,'FFT_OUTPUT_FORMAT_REAL_S32',3,'FFT_OUTPUT_FORMAT_IMAG_S32',4,'FFT_OUTPUT_FORMAT_FLOAT_AMP2',10,'FFT_OUTPUT_FORMAT_FLOAT_LOG',11,'FFT_OUTPUT_FORMAT_RAW_PLUS_FFT',4096);
methodinfo=fcns;