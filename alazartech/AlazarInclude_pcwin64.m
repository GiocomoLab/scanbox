...
%This function was generated by loadlibrary.m parser version  on Wed Aug 10 13:43:20 2016
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarBusyFlag'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8Ptr'};fcnNum=fcnNum+1;
% unsigned int AlazarTriggeredFlag ( HANDLE h , BOOLEAN * TriggeredFlag ); 
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarTriggeredFlag'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8Ptr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarDSPGetModules'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'voidPtrPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrvoidPtrvoidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarDSPGetInfo'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulongPtr', 'uint16Ptr', 'uint16Ptr', 'ulongPtr', 'ulongPtr', 'ulongPtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrulongvoidPtrThunk';fcns.name{fcnNum}='AlazarFFTGetMaxTriggerRepeatRate'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'doublePtr'};fcnNum=fcnNum+1;
% unsigned int AlazarFFTBackgroundSubtractionSetRecordS16 ( dsp_module_handle dspHandle , const S16 * record , U32 size_samples ); 
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrulongThunk';fcns.name{fcnNum}='AlazarFFTBackgroundSubtractionSetRecordS16'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int16Ptr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrvoidPtrulongThunk';fcns.name{fcnNum}='AlazarFFTBackgroundSubtractionGetRecordS16'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'int16Ptr', 'ulong'};fcnNum=fcnNum+1;
% unsigned int AlazarFFTBackgroundSubtractionSetEnabled ( dsp_module_handle dspHandle , U8 enabled ); 
fcns.thunkname{fcnNum}='uint32voidPtruint8Thunk';fcns.name{fcnNum}='AlazarFFTBackgroundSubtractionSetEnabled'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlazarFFTSetWindowFunction'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'singlePtr', 'singlePtr'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtruint8voidPtrvoidPtrulongThunk';fcns.name{fcnNum}='AlazarFFTVerificationMode'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8', 'int16Ptr', 'int16Ptr', 'ulong'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtruint16ulongulongulongulongulongvoidPtrThunk';fcns.name{fcnNum}='AlazarFFTSetup'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint16', 'ulong', 'ulong', 'ulong', 'ulong', 'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
% unsigned int AlazarFFTSetScalingAndSlicing ( dsp_module_handle dspHandle , U8 slice_pos , float loge_ampl_mult ); 
fcns.thunkname{fcnNum}='uint32voidPtruint8floatThunk';fcns.name{fcnNum}='AlazarFFTSetScalingAndSlicing'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'uint8', 'single'};fcnNum=fcnNum+1;
...
fcns.thunkname{fcnNum}='uint32voidPtrulongvoidPtrThunk';fcns.name{fcnNum}='AlazarDSPGetParameterU32'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='uint32'; fcns.RHS{fcnNum}={'voidPtr', 'ulong', 'ulongPtr'};fcnNum=fcnNum+1;
